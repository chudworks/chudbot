...
/// uploaded images are addressed by exact media/context URI strings, not by
/// guessed filenames.
pub(crate) fn image_generation_tool_description(
    ...
    format!(
        concat!(
            ...
            "visible in the conversation, pass their exact image URI string(s) in ",
            "`reference_images`: `media://images/...` for uploaded/generated images, ",
            "`media://avatars/...` for cached avatar files, `media://guild-icons/...` ",
            "for cached guild icon files, `user_avatar://current` or ",
            "`user_avatar://<user_id>` for cached user avatars, and `guild_icon://current` ",
            "or `guild_icon://<current_guild_id>` for the current guild icon. Legacy ",
            "stored `file://images/...`, `file://avatars/...`, and ",
            "`file://guild-icons/...` URI strings are valid when already present in ",
            "context; public http(s) image URLs also work. This is the expected path for requests like \"turn this image ",
            "into...\", \"make the image...\", \"use the previous image\", or \"here's a ",
            "different version\". User-uploaded images are listed in image attachment ",
            "reference notes; generated images are listed in prior tool results and ",
            "generated-media reference notes. Never invent or guess paths, and never ",
            "derive `media://avatars/<user_id>.jpg` from a user id. Do not use ",
            "`avatar://`, `avatars://`, or `media://user_avatars/...`; use the ",
            "`avatar_uri` value from message context instead. ",
...
pub(crate) fn video_generation_tool_description(binding: &GenerationBinding) -> String {
    let mut description = format!(
        concat!(
            ...
            "version of something. To animate an existing image, pass its exact image ",
            "URI string as `image`: `media://images/...` for uploaded/generated images, ",
            "`media://avatars/...` for cached avatar files, `media://guild-icons/...` ",
            "for cached guild icon files, `user_avatar://current` or ",
            "`user_avatar://<user_id>` for cached user avatars, and `guild_icon://current` ",
            "or `guild_icon://<current_guild_id>` for the current guild icon. Legacy ",
            "stored `file://images/...`, `file://avatars/...`, and ",
            "`file://guild-icons/...` URI strings are valid when already present in ",
            "context; public http(s) image URLs also work. User-uploaded images are ",
            "listed in image attachment reference notes and generated images in prior ",
            "tool results. Never invent or guess paths, and never derive ",
            "`media://avatars/<user_id>.jpg` from a user id. Do not use `avatar://`, ",
            "`avatars://`, or `media://user_avatars/...`; use the `avatar_uri` value ",
            "from message context instead.\n\n",
